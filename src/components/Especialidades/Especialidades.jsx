...
const Especialidades = () => {
  ...
  const fuse = new Fuse(specialties, {
    keys: ['name', 'description'], // Las claves a buscar
    includeScore: true, // Incluir la puntuación (qué tan cerca está la coincidencia)
  ...
  const SpecialtyCard = ({ specialty, navigate }) => (
