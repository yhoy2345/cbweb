        ...
        <Background>
            <div className="derma-container">
                ...
                <div className="derma-hero">
                    <img
                        src="/images/plastic-surgery.jpg"
                        alt="Consulta de cirugía plástica y reconstructiva"
                        className="derma-hero__image"
                    />
                    <div className="derma-hero__overlay"></div>
                    <h1 className="derma-hero__title">{cirugiaPlasticaData.name}</h1>
                </div>
                ...
                <main className="derma-main">
                    <div className="derma-intro__content">
                        ...
                        <p className="derma-intro__text">{cirugiaPlasticaData.description}</p>
                            ...
                            <div className="d-flex contenido-servicio bg-white">
                                <div className="especialidad-container">
                                    <div className="texto-especialidad">
                                        ...
                                        <p>Especializados en procedimientos estéticos y reconstructivos, ofrecemos soluciones quirúrgicas para mejorar la apariencia y restaurar la funcionalidad en casos de traumatismos, malformaciones o enfermedades.</p>
                                        <h4 id="nuestros-profesionales"><span>Nuestros Profesionales</span></h4>
                                        <p>Cirujanos plásticos certificados con experiencia en procedimientos estéticos y reconstructivos, comprometidos con resultados naturales y la seguridad del paciente.</p>
                                    </div>
                                    
                                    <div className="collage-profesionales">
                                        <img 
                                            src="https://images.unsplash.com/photo-1580281658626-0f8a01ebb60e?w=200" 
                                            alt="Cirujano Plástico 1" 
                                            className="foto-profesional foto-1" 
                                        />
                                        <img 
                                            src="https://images.unsplash.com/photo-1576091160550-2a6adeda52c0?w=180" 
                                            alt="Cirujano Plástico 2" 
                                            className="foto-profesional foto-2" 
                                        />
                                        <img 
                                            src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=220" 
                                            alt="Cirujano Plástico 3" 
                                ...
                                <div className="procedimientos-container">
                                    ...
                                    <ul className="list-tag">
                                        <li>
                                            ...
                                            <span>Rinoplastia estética y funcional.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Lifting facial y cervical.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Aumento y reducción mamaria.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Reconstrucción mamaria post-mastectomía.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Liposucción y abdominoplastia.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Reconstrucción de defectos congénitos o traumáticos.</span>
                                        </li>
                                    </ul>
                                    <p>Ofrecemos procedimientos estéticos y reconstructivos con tecnología avanzada y técnicas innovadoras, garantizando resultados seguros y satisfactorios.</p>
                                </div>
                                <div className="atencion-container">
                                    <h4 id="presta-atencion"><span>Presta Atención</span></h4>
                                    <p>Los procedimientos más comunes incluyen cirugías estéticas como rinoplastia y liposucción, así como reconstructivas para corregir defectos congénitos, traumatismos o secuelas oncológicas. Contamos con un equipo especializado para un tratamiento personalizado.</p>
                                </div>
                                <div className="staff-container">
                                    <h4 id="nuestro-staff"><span>Nuestro Staff</span></h4>
                                    <p>Nuestros cirujanos plásticos cuentan con certificaciones internacionales y experiencia en procedimientos estéticos y reconstructivos, asegurando una atención integral y profesional.</p>
                                    <div className="d-flex lista-resultado">
                                        <div className="d-flex lista">
                                            <div className="d-flex gap-3">
                                                <div className="d-flex avatar">
                                                    <img src="https://citaweb.clinicasanfelipe.com/Files/M3dicosX/Dr.EjemploCirujanoPlastico.jpg" alt="DR. EJEMPLO CIRUJANO PLÁSTICO" />
                                                </div>
                                                <div className="d-flex flex-column descripcion">
                                                    <span className="area">Cirujano Plástico</span>
                                                    <div className="nombre">DR. EJEMPLO CIRUJANO PLÁSTICO</div>
...
export default CirugiaPlasticaReconstructiva;