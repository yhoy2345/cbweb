...
const Neurologia = () => {
    ...
    const neurologiaData = specialties.find(
        esp => esp.url === "/especialidades/neurologia"
    );
            ...
            <div className="derma-container">
                ...
                <div className="derma-hero">
                    <img
                        ...
                        alt="Consulta de neurología"
                        className="derma-hero__image"
                    />
                    <div className="derma-hero__overlay"></div>
                    <h1 className="derma-hero__title">{neurologiaData.name}</h1>
                </div>
                ...
                <main className="derma-main">
                    <div className="derma-intro__content">
                        ...
                        <p className="derma-intro__text">{neurologiaData.description}</p>
                            ...
                            <div className="d-flex contenido-servicio bg-white">
                                <div className="especialidad-container">
                                    <div className="texto-especialidad">
                                        ...
                                        <p>Especializados en el diagnóstico y tratamiento de trastornos del sistema nervioso, ofrecemos atención integral para afecciones neurológicas, desde migrañas hasta enfermedades neurodegenerativas.</p>
                                        <h4 id="nuestros-profesionales"><span>Nuestros Profesionales</span></h4>
                                        <p>Neurólogos certificados con experiencia en el manejo de enfermedades cerebrales, medulares y nerviosas, utilizando tecnología avanzada para diagnósticos precisos y tratamientos personalizados.</p>
                                    </div>
                                ...
                                <div className="procedimientos-container">
                                    ...
                                    <ul className="list-tag">
                                        <li>
                                            ...
                                            <span>Electroencefalograma (EEG).</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Electromiografía (EMG).</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Tratamiento de migrañas y cefaleas.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Manejo de epilepsia.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Diagnóstico de enfermedades neurodegenerativas (Alzheimer, Parkinson).</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Tratamiento de accidentes cerebrovasculares.</span>
                                        </li>
                                    </ul>
                                    <p>Ofrecemos diagnóstico y tratamiento de trastornos neurológicos con tecnología de vanguardia, garantizando una atención integral y personalizada para cada paciente.</p>
                                </div>
                                <div className="atencion-container">
                                    <h4 id="presta-atencion"><span>Presta Atención</span></h4>
                                    <p>Las afecciones neurológicas más comunes incluyen migrañas, epilepsia, accidentes cerebrovasculares, y enfermedades neurodegenerativas como Alzheimer y Parkinson. Contamos con un equipo especializado y tecnología avanzada para un diagnóstico preciso.</p>
                                </div>
                                <div className="staff-container">
                                    <h4 id="nuestro-staff"><span>Nuestro Staff</span></h4>
                                    <p>Nuestros neurólogos cuentan con certificaciones internacionales y experiencia en el manejo de trastornos neurológicos, asegurando un cuidado integral y profesional.</p>
                                    <div className="d-flex lista-resultado">
                                        <div className="d-flex lista">
                                            <div className="d-flex gap-3">
                                                <div className="d-flex avatar">
                                                    <img src="https://citaweb.clinicasanfelipe.com/Files/M3dicosX/Dr.EjemploNeurologo.jpg" alt="DR. EJEMPLO NEURÓLOGO" />
                                                </div>
                                                <div className="d-flex flex-column descripcion">
                                                    <span className="area">Neurólogo</span>
                                                    <div className="nombre">DR. EJEMPLO NEURÓLOGO</div>
                                                    <span className="badge">CMD:</span>
                                                </div>
                                            </div>
                                            {/* CTA Section
                                            <div className="d-flex ctas">
                                                <a href="../medicos/ejemplo-neurologo" className="btn btn-primary-outline px-4 py-2">Conócelo aquí</a>
                                            </div>*/}
                                        </div>
                                    </div>
                                </div>    
                    ...
                    <section className="derma-cta">
                        <h3 className="derma-cta__title">¿Necesitas una consulta de neurología?</h3>
