...
const Urologia = () => {
    ...
    const urologiaData = specialties.find(
        esp => esp.url === "/especialidades/urologia"
    );
        ...
        <Background>
            <div className="derma-container">
                ...
                <div className="derma-hero">
                    <img
                        src="/images/urology.jpg"
                        alt="Consulta de urología"
                        className="derma-hero__image"
                    />
                    <div className="derma-hero__overlay"></div>
                    <h1 className="derma-hero__title">{urologiaData.name}</h1>
                </div>
                ...
                <main className="derma-main">
                    <div className="derma-intro__content">
                        ...
                        <p className="derma-intro__text">{urologiaData.description}</p>
                            ...
                            <div className="d-flex contenido-servicio bg-white">
                                <div className="especialidad-container">
                                    <div className="texto-especialidad">
                                        ...
                                        <p>Especializados en el diagnóstico y tratamiento de enfermedades del sistema urinario y reproductor masculino, ofrecemos soluciones médicas y quirúrgicas para mejorar la salud urológica.</p>
                                        <h4 id="nuestros-profesionales"><span>Nuestros Profesionales</span></h4>
                                        <p>Urólogos certificados con experiencia en procedimientos quirúrgicos y no quirúrgicos para afecciones renales, vesicales y prostáticas, comprometidos con la atención integral del paciente.</p>
                                    </div>
                                ...
                                <div className="procedimientos-container">
                                    ...
                                    <ul className="list-tag">
                                        <li>
                                            ...
                                            <span>Cistoscopia diagnóstica.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Litotricia para cálculos renales.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Prostatectomía y biopsia prostática.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Tratamiento de infecciones urinarias.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Vasectomía y reversión de vasectomía.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Cirugía de incontinencia urinaria.</span>
                                        </li>
                                    </ul>
                                    <p>Ofrecemos diagnósticos y tratamientos avanzados para afecciones urológicas, utilizando tecnología de punta y técnicas mínimamente invasivas.</p>
                                </div>
                                <div className="atencion-container">
                                    <h4 id="presta-atencion"><span>Presta Atención</span></h4>
                                    <p>Las afecciones urológicas más comunes incluyen cálculos renales, infecciones urinarias, hiperplasia prostática y disfunción eréctil. Contamos con un equipo especializado para un diagnóstico y tratamiento precisos.</p>
                                </div>
                                <div className="staff-container">
                                    <h4 id="nuestro-staff"><span>Nuestro Staff</span></h4>
                                    <p>Nuestros urólogos cuentan con certificaciones internacionales y experiencia en el manejo de enfermedades urológicas, garantizando una atención integral y profesional.</p>
                                    <div className="d-flex lista-resultado">
                                        <div className="d-flex lista">
                                            <div className="d-flex gap-3">
                                                <div className="d-flex avatar">
                                                    <img src="https://citaweb.clinicasanfelipe.com/Files/M3dicosX/Dr.EjemploUrologo.jpg" alt="DR. EJEMPLO URÓLOGO" />
                                                </div>
                                                <div className="d-flex flex-column descripcion">
                                                    <span className="area">Urólogo</span>
                                                    <div className="nombre">DR. EJEMPLO URÓLOGO</div>
                                                    <span className="badge">CMD:</span>
                                                </div>
                                            </div>
                                            <div className="d-flex ctas">
                                                <a href="../medicos/ejemplo-urologo" className="btn btn-primary-outline px-4 py-2">Conócelo aquí</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>    
                    ...
                    <section className="derma-cta">
                        <h3 className="derma-cta__title">¿Necesitas una consulta de urología?</h3>
