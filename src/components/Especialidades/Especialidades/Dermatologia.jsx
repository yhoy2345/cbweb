            ...
            <div className="derma-container">
                ...
                <main className="derma-main">
                            ...
                            <div className="d-flex contenido-servicio bg-white">
                                <div className="especialidad-container">
                                    <div className="texto-especialidad">
                                        ...
                                        <p>Especializados en el diagnóstico y tratamiento de enfermedades de la piel, cabello y uñas, ofrecemos soluciones para afecciones dermatológicas en adultos y niños, utilizando tecnología avanzada y tratamientos personalizados.</p>
                                        <h4 id="nuestros-profesionales"><span>Nuestros Profesionales</span></h4>
                                        <p>Dermatólogos certificados con experiencia en dermatología clínica, estética y quirúrgica, comprometidos con la salud y el bienestar de la piel de nuestros pacientes.</p>
                                    </div>
                                    
                                    <div className="collage-profesionales">
                                        <img 
                                            src="https://images.unsplash.com/photo-1570172619644-d4f8682646a1?w=200" 
                                            alt="Dermatólogo 1" 
                                            className="foto-profesional foto-1" 
                                        />
                                        <img 
                                            src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=180" 
                                            alt="Dermatólogo 2" 
                                            className="foto-profesional foto-2" 
                                        />
                                        <img 
                                            src="https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=220" 
                                            alt="Dermatólogo 3" 
                                ...
                                <div className="procedimientos-container">
                                    ...
                                    <ul className="list-tag">
                                        <li>
                                            ...
                                            <span>Biopsias de piel.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Tratamiento de acné y rosácea.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Eliminación de lunares y verrugas.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faUserDoctor} className="icon-spacing"/>
                                            <span>Crioterapia para lesiones cutáneas.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Terapias láser para cicatrices y manchas.</span>
                                        </li>
                                        <li>
                                            <FontAwesomeIcon icon={faSyringe} className="icon-spacing"/>
                                            <span>Tratamientos estéticos (botox, fillers).</span>
                                        </li>
                                    </ul>
                                    <p>Ofrecemos procedimientos dermatológicos con tecnología de vanguardia, enfocados en la seguridad, la estética y la salud integral de la piel.</p>
                                </div>
                                <div className="atencion-container">
                                    <h4 id="presta-atencion"><span>Presta Atención</span></h4>
                                    <p>Las afecciones dermatológicas más comunes incluyen acné, dermatitis, psoriasis, cáncer de piel y alopecia. Contamos con equipos especializados para diagnóstico y tratamiento, además de consultas personalizadas para cada paciente.</p>
                                </div>
                                <div className="staff-container">
                                    <h4 id="nuestro-staff"><span>Nuestro Staff</span></h4>
                                    <p>Nuestros dermatólogos cuentan con certificaciones internacionales y experiencia en el manejo de afecciones cutáneas complejas, garantizando un enfoque integral y profesional.</p>
                                    <div className="d-flex lista-resultado">
                                        <div className="d-flex lista">
                                            <div className="d-flex gap-3">
                                                <div className="d-flex avatar">
                                                    <img src="https://citaweb.clinicasanfelipe.com/Files/M3dicosX/Dr.EjemploDermatologo.jpg" alt="DR. EJEMPLO DERMATÓLOGO" />
                                                </div>
                                                <div className="d-flex flex-column descripcion">
                                                    <span className="area">Dermatólogo</span>
                                                    <div className="nombre">DR. EJEMPLO DERMATÓLOGO</div>
                                                    <span className="badge">CMD:</span>
                                                </div>
                                            </div>
                                            {/* Call to Action 
                                            <div className="d-flex ctas">
                                                <a href="../medicos/ejemplo-dermatologo" className="btn btn-primary-outline px-4 py-2">Conócelo aquí</a>
                                            </div>*/}
                                        </div>
                                    </div>
                                </div>    
                    ...
                    <section className="derma-cta">
                        <h3 className="derma-cta__title">¿Necesitas una consulta dermatológica?</h3>
